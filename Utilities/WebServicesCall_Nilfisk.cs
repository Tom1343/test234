...
{
    public static class WebServicesCall_Nilfisk
    {
        private const string _url = "https://power-nilfiskbe-soap.emea.tst.api.itglo.net/CGI/WS/NILFISKBE/Codeunit/POWAutoTestingWS?tenant=nilfiskbe";

        private const string _action = "urn:microsoft-dynamics-schemas/codeunit/AutoTestingWS";
