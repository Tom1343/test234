...
{
    public static class WebServicesCall_SkatePro
    {
        private const string _url = "https://power-skatepro-soap.emea.tst.api.itglo.net/CGI/WS/SKATEPRO/Codeunit/POWAutoTestingWS?tenant=skatepro";
