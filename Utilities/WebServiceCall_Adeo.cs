...
{
    public static class WebServicesCall_Adeo
    {
        private const string _url = "https://power-adeo-soap.emea.tst.api.itglo.net/CGI/WS/Codeunit/POWAutoTestingWS?tenant=adeo";
