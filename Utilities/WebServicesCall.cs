...
{
    public static class WebServicesCall
    {
        private const string _url = "https://power-baseline-soap.emea.tst.api.itglo.net/CGI/WS/Codeunit/POWAutoTestingWS?tenant=baseline";
