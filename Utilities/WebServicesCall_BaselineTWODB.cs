...
{
    public static class WebServicesCall_BaselineTWODB
    {
        private const string _url = "https://power-baselinetwo-soap.emea.tst.api.itglo.net/CGI/WS/Codeunit/POWAutoTestingWS?tenant=baselinetwo";

        private const string _action = "urn:microsoft-dynamics-schemas/codeunit/AutoTestingWS:AutoTest_ImportConfigPackage";

        public static void WebServicePostCallBaseline(string p0)
        {
        ...
        private static XmlDocument CreateSoapEnvelope(string p0)
        {
            ...
            //soapEnvelopeDocument.Load("//S-be-ki-abrain2/EDIFILES_TEST/BASELINE/TESTTEAM/BCWebservice/" + p0);
            ...
            XmlDocument soapEnvelopeDocument = new XmlDocument();
            //soapEnvelopeDocument.Load("//ktn.group/Public/BE-KI/Datashares/Share Analyze Consumers/21 TEST TEAM/Bashkim/BCData/PutawaySAM/PackageSAM_BB_PUTWAY.xml");
            soapEnvelopeDocument.Load("//itglo.net/public/EMEA/BE-KI/DataShares/Share Analyze Consumers/21 TEST TEAM/Bashkim/BCData/BaselineStyra/" + p0);
            return soapEnvelopeDocument;
        }
